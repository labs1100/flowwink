      ...
      },
      {
        ...
        data: {
          ...
          items: [
            ...
            { question: 'How does the headless API work?', answer: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'FlowWink is "head + headless"—you get a beautiful built-in website AND a complete REST/GraphQL API. Use the visual site, the API, or both depending on the client need.' }] }] } },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          tabs: [
            ...
            { id: 'tab-integrations', title: 'Integrations', icon: 'Plug', content: '<h3>Connect to Everything</h3><p>Headless API, webhooks, and native integrations for your workflow.</p><ul><li>REST and GraphQL API</li><li>Webhooks for any event</li><li>Stripe payments built-in</li><li>Zapier/Make compatible</li><li>Custom code when needed</li></ul>' },
          ],
          orientation: 'horizontal',
          variant: 'underline',
        },
