          ...
          data: {
            ...
            rightColumn: {
              ...
              content: [
                ...
                { type: 'paragraph', content: [{ type: 'text', text: '— Marcus Lindström, Cloud Architect' }] },
              ],
            },
      ...
      blocks: [
        ...
        },
        {
          ...
          data: {
            ...
            members: [
              { id: 'r1', name: 'Marcus Lindström', role: 'Cloud Architect — AWS & Azure', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400', bio: '12 yrs cloud. AWS Solutions Architect, Azure Expert. Led 3 Fortune 500 migrations. Available Aug.', linkedin: 'https://linkedin.com' },
      ...
      blocks: [
        ...
        // CONSULTANT TESTIMONIALS
        {
          ...
          data: {
            ...
            testimonials: [
              ...
              { id: 'tcon2', content: 'They called me 5 weeks before my assignment ended with three new briefs. All interesting. I had my pick. That\'s how it should work.', author: 'Marcus Lindström', role: 'Cloud Architect', company: 'Member since 2021', rating: 5 },
        ...
        { id: 'sep-apply', type: 'separator', data: { id: 'apply', variant: 'text', text: 'Apply to Join', icon: 'UserPlus' } },
        {
          ...
          data: {
            ...
            fields: [
              { id: 'af-name', type: 'text', label: 'Your Name', placeholder: 'Marcus Lindström', required: true },
